...
func TestListPeopleWritesList(t *testing.T) {
	...
	in := pb.AddressBook{People: []*pb.Person{
		...
		},
		{
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-555-5555", Type: pb.PhoneType_PHONE_TYPE_WORK},
			},
		},
		{
			Name:  "Jack Buck",
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-555-0000", Type: pb.PhoneType_PHONE_TYPE_HOME},
				{Number: "555-555-0001", Type: pb.PhoneType_PHONE_TYPE_MOBILE},
		...
		},
		{
			...
			Phones: []*pb.Person_PhoneNumber{
				{Number: "555-777-0000"},
				{Number: "555-777-0001", Type: pb.PhoneType_PHONE_TYPE_HOME},
			},
		},
	}}
	listPeople(buf, &in)
