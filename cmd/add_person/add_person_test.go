...
`
	...
	want := []*pb.Person_PhoneNumber{
		{Number: "123-456-7890", Type: pb.PhoneType_PHONE_TYPE_HOME},
		{Number: "222-222-2222", Type: pb.PhoneType_PHONE_TYPE_MOBILE},
		{Number: "111-111-1111", Type: pb.PhoneType_PHONE_TYPE_WORK},
		{Number: "333-333-3333", Type: pb.PhoneType_PHONE_TYPE_UNSPECIFIED},
	}
